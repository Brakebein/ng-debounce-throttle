 ...
 * https://github.com/Brakebein/ng-debounce-throttle
 *
 * Code and documentation are partly adopted from
 * * https://github.com/shahata/angular-debounce Copyright (c) 2013 Steve
...
(function () {
	...
	function $throttle($rootScope, $timeout) {
		 ...
		 * @return A throttled version of the passed function. Any arguments passed to this function will be also passed. The returned function also has a `cancel()` method, which can be used in case you want to reset the current throttle state. This will cause that the next input will trigger the function immediately.
		 */
